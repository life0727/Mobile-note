  ...
  <nav class="index_nav navbar navbar-default" style="min-height: 78px;margin-bottom: 0;background-color: #090723;border-color:#090723;border-radius: 0;min-width: 1250px;">
    <div class="container" style="padding-top: 14px;">
      ...
      <div class="navbar-header">
        ...
        <router-link class="navbar-brand" to="/main/refer">
           <img alt="Brand" src="../assets/icon/793549342520256102.png" style="margin-top: -16px;">
        </router-link>>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li style=""> <router-link :class="this.$route.path=='/main/refer' ?  'active' : ''" to="/main/refer">舆情监测</router-link></li>
          <li><router-link to="/custom" :class="this.$route.path=='/custom' ?  'active' : ''">客户管理</router-link>></li>
          <!-- <li><a href="#"><b>. . .</b></a></li> -->
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li style="margin-left: 15px;">
              <span style="color:rgba(255,255,255,0.5);line-height: 50px;font-size: 18px;">当前项目<i class="fa fa-angle-right " style="font-size: 18px;margin-left: 3px;color:rgba(255,255,255,0.5)"></i></span>
              <el-dropdown style="margin-left: 5px;font-size: 18px;"  @command="handleCommand">
               ...
               <el-dropdown-menu slot="dropdown" id="dropdown_item"  >
                  <el-dropdown-item v-for="i in item" style="position:relative;min-width: 120px;" :command="i.name">{{i.name}}
                    <img src="../assets/icon/del.png" @click.stop="del_item(i)" style="position:absolute;right: 4px;;top:10px;">
                  </el-dropdown-item>
                    <router-link to="/index/clever/clever_content" style="text-decoration: none;color:#00b38a;">
                      <li style="list-style: none;line-height: 36px;padding: 0 18px;margin: 0;position: relative;cursor: pointer;">
            ...
            <li style="margin-left: 25px;">
              ...
              <ul class="dropdown-menu" style="min-width: 80px;" id="admin">         
                ...
                <li>
                  ...
                  <a href="javascript:;" style="padding: 5px;font-size: 14px;color: #333;line-height: 20px;display: inline-block" @click="logout">注销</a>
                </li>
              </ul>
            </li>
        </ul>
